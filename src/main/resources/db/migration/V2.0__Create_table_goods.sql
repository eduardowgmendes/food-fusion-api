...
(
    ...
    maker VARCHAR(255) COLLATE pg_catalog."default",
    ...
    sku_code VARCHAR(255) COLLATE pg_catalog."default",
    ...
    gtin_code VARCHAR(255) COLLATE pg_catalog."default",
    ncm_code VARCHAR(255) COLLATE pg_catalog."default",
